...
using ToDoAPI.Filters; // forwarded headers
...
{
    //options.Filters.Add<SampleExceptionFilter>();   // Apply SampleExceptionFilter globally
    options.Filters.Add<LogActionFilter>();         // Apply LogActionFilter globally
...
app.MapControllers(); // to handle Attribute-routing in controllers or actions
/*app.MapControllerRoute(
        name:       "default",
        pattern: "{controller=TodoItems}/{action=GetAllTodoItems}"
    ); // Convention-routing for controllers
*/
